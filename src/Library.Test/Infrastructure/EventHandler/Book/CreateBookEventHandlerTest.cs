...
[TestClass]
public class CreateBookEventHandlerTest : BaseTest
{
    private Mock<IBus> _mockBus;
    private Mock<ISendEndpoint> _mockSendEndpoint;
    private IConfiguration _configuration;
    private CreateBookEventHandler _handler;
    ...
    public void Init()
    {
        ...
        var myConfiguration = new Dictionary<string, string>
            {
                {"RabbitMq:CreateBookQueue", "value"}
            };
    ...
    {
        var param = _fixture.Create<CreatedBookEvent>();
