...
[TestClass]
public class UpdateAuthorEventHandlerTest
{
    private Mock<IBus> _mockBus;
    private Mock<ISendEndpoint> _mockSendEndpoint;
    private IConfiguration _configuration;
    private UpdateAuthorEventHandler _handler;
    ...
    public void Init()
    {
        ...
        var myConfiguration = new Dictionary<string, string>
            {
                {"RabbitMq:UpdateAuthorQueue", "value"}
            };
    ...
    {
        var param = _fixture.Create<UpdateAuthorEvent>();
