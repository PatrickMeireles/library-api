...
[TestClass]
public class CreateAuthorEventHandlerTest
{
    private Mock<IBus> _mockBus;
    private Mock<ISendEndpoint> _mockSendEndpoint;
    private IConfiguration _configuration;
    private CreateAuthorEventHandler _handler;
    ...
    public void Init()
    {
        ...
        var myConfiguration = new Dictionary<string, string>
            {
                {"RabbitMq:CreateAuthorQueue", "value"}
            };
    ...
    {
        var param = _fixture.Create<CreatedAuthorEvent>();
