...
[TestClass]
public class CreateBookConsumerTest
{
    private CreateBookConsumer _consumer;
    private Mock<IBookMongoRepository> _repository;
    private Mock<ICacheService> _mockCacheService;
    private ConsumeContext<CreateBookMessage> _consumeContext;

    [TestInitialize]
    public void Init()
    {
        _consumeContext = Mock.Of<ConsumeContext<CreateBookMessage>>(_ => _.Message == new CreateBookMessage());
        _repository = new();
