...
[TestClass]
public class UpdateAuthorConsumerTest
{
    private UpdateAuthorConsumer _consumer;
    private Mock<IAuthorMongoRepository> _repository;
    private Mock<ICacheService> _mockCacheService;
    private ConsumeContext<UpdateAuthorMessage> _consumeContext;

    [TestInitialize]
    public void Init()
    {
        _consumeContext = Mock.Of<ConsumeContext<UpdateAuthorMessage>>(_ => _.Message == new UpdateAuthorMessage());
        _repository = new();
